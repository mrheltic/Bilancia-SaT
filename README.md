...
| <p style="width:200px; overflow:auto">The 9V battery is used as a portable power source for the project.</p> | <p style="width:200px; overflow:auto">The HW-139 touch button is a component used for touch detection. It can be used as a tare button for resetting the scale.</p> | <p style="width:200px; overflow:auto">The I2C 16x2 LCD display is used to show information such as the measured weight or other relevant details.</p> |
...
| <p style="width:200px; overflow:auto">The ON-OFF switch is used to control the power supply to the circuit.</p> | <p style="width:200px; overflow:auto">The ATtiny or Arduino Nano are some examples of a microcontroller development board used for programming and controlling the scale and its components.</p> | <p style="width:200px; overflow:auto">The 5KG load cell is a weight sensor used to measure the weight of objects placed on the plate.</p> |
...
| <p style="width:200px; overflow:auto">The HX711 is used to amplify and convert the analog signal from the load cell into a digital one that can be read by the microcontroller.</p> | <p style="width:200px; overflow:auto">The PCB (Printed Circuit Board) is used to connect and organize the electronic components in the project.</p> | <p style="width:200px; overflow:auto">Rubber supports needed to avoid sliding and suport the structure of the scale.</p> |
